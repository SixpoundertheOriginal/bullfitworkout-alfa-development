...
('Lateral Raises', 'Isolation exercise for side delts', 
 ARRAY['shoulders'], ARRAY[], ARRAY['dumbbell'], 
 'push', 'beginner', 
...
('Bicep Curls', 'Isolation exercise for biceps', 
 ARRAY['biceps'], ARRAY[], ARRAY['dumbbell'], 
 'pull', 'beginner', 
...
('Plank', 'Isometric core exercise', 
 ARRAY['core'], ARRAY[], ARRAY['bodyweight'], 
 'isometric', 'beginner', 
...
('Burpees', 'Full-body cardio exercise', 
 ARRAY['full body'], ARRAY[], ARRAY['bodyweight'], 
 'squat', 'intermediate', 
...
('Jumping Jacks', 'Simple cardio exercise', 
 ARRAY['cardio'], ARRAY[], ARRAY['bodyweight'], 
 'squat', 'beginner', 
